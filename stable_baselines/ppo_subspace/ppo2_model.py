...
class PPO2(ActorCriticRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, n_steps=128, ent_coef=0.01, learning_rate=2.5e-4, vf_coef=0.5,
                 ...
                 full_tensorboard_log=False, pcs=(), origin_theta=None):
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope('model'):
                    ...
                    self.set_from_flat = tf_util.SetFromFlat(NN, sess=self.sess)

                    self.set_from_flat(self.origin_theta)

                    for i, pc in enumerate(self.pcs):
                        NN = tf.get_collection(f"{mult_conllection_prefix}_{i}")
    ...
    def learn(self, total_timesteps, callback=None, seed=None, log_interval=1, tb_log_name="PPO2",
              reset_num_timesteps=True, give_optimization_path=False):
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            return [ep_info['r'] for ep_info in ep_full_infos], optimization_path
