...
if __name__ == '__main__':
    ...
    parser.add_argument('--total_timesteps', default=6000, type=int, help='total timesteps agent runs')
...
####################################go for file size
    ...
    dump(plot_dir_alg, proj_xcoord, "proj_xcoord")
    dump(plot_dir_alg, proj_ycoord, "proj_ycoord")
    dump(plot_dir_alg, pca.explained_variance_ratio_[:2], "explained_variance_ratio")
    dump(plot_dir_alg, proj_errors, "proj_errors")
    dump(plot_dir_alg, insofar_pca_explain_num, "insofar_pca_explain_num")
    dump(plot_dir_alg, np.cumsum(pca.explained_variance_ratio_), "cum_sum explained_variance")


    plot_contour_trajectory(plot_dir_alg, proj_xcoord, proj_ycoord, pca.explained_variance_ratio_[:2], show=args.show)
    plot_trajectory_wtih_error_only(plot_dir_alg, proj_xcoord, proj_ycoord, proj_errors,
                                    pca.explained_variance_ratio_[:2], show=args.show)
    plot_trajectory_wtih_num_to_explain_only(plot_dir_alg, proj_xcoord, proj_ycoord, insofar_pca_explain_num,
                                    pca.explained_variance_ratio_[:2], show=args.show)