...
def plot_trajectory_wtih_error_only(check_index, plot_dir_alg,
    ...
    logger.log(f"saving plot to {plot_dir_alg}")
...
def dump_my(dir_name, data, file_name):
    ...
    logger.log(f"dumping to {var_output_file}")
...
if __name__ == '__main__':
    ...
    logger.log(f"saving plots in: {plot_dir_alg}")
    logger.log(f"reading traj in: {traj_params_dir_name}")
