...
def main():
    import argparse
    import os
    log_dirs = ["/home/panda-linux/PycharmProjects/low_dim_update_dart/low_dim_update_stable/new_neuron_analysis/result/DartWalker2d-v1_policy_num_timesteps_5000000_policy_run_num_0_policy_seed_4_run_seed_5_run_run_num_5_additional_note_testingnewmetricweightedifnotmight_need_to_revert_back/env_gym.envs.dart:DartWalker2dEnv_aug_input_time_step_1500000_run_0_seed_0_learning_rate_0.0003_top_num_to_include_0:0_network_size_64/the_log_dir"]
    parser = argparse.ArgumentParser(formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument('--dirs', help='List of log directories', nargs = '*', default=log_dirs)
